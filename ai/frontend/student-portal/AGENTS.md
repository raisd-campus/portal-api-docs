...
- Announcements ([CAP-16](../../../sdd/11-capability-catalog.md#cap-16)) is read-only student viewing: campus-owned clickable-list/detail pages and dashboard links with structured rich content. Admin editing/publishing, read tracking, notifications, attachments and persistence remain outside scope.
- [CAP-33](../../../sdd/11-capability-catalog.md#cap-33) learner support is represented by the session-only IT Helpdesk conversation in Community. Formal support forms, ticket/case tracking, service-level commitments and staff operations remain [CAP-51](../../../sdd/11-capability-catalog.md#cap-51) or future backend work.
- [CAP-35](../../../sdd/11-capability-catalog.md#cap-35) Accessibility Support is a campus-owned Services placeholder plus an engineering WCAG 2.2 A/AA audit of the supported desktop portal. Do not invent campus services, eligibility, medical guidance, policies or contacts. Accessibility requests, documents, case tracking and staff responses remain [CAP-51](../../../sdd/11-capability-catalog.md#cap-51). Audit evidence is not formal certification or full mobile/assistive-technology acceptance.
- [CAP-39](../../../sdd/11-capability-catalog.md#cap-39) Privacy & Security is a read-only campus-owned Profile demonstration. It may explain portal information use, available frontend actions and account-security guidance, but must not claim an approved legal basis, retention period, regulatory compliance or production security. Formal privacy requests and case tracking remain [CAP-51](../../../sdd/11-capability-catalog.md#cap-51); authentication, authorization, retention enforcement, audit logging and security operations remain backend responsibilities.
